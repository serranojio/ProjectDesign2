...
const mqttBrokerAddress = 'mqtt://192.168.1.18'; // ip address of raspi // 192.168.141.249 (Bry), 192.168.160.249 (Jio), 192.168.143.249 (Isidro)
                ...
                await data.Body.once('end', async () => {
                    ...
                    try {
                        ...
                        const roboflowResponse = await axios({
                            method: "POST",
                            url: "https://detect.roboflow.com/final-data-set-zs3lw/2",
                            params: {
                                api_key: apiKey,
                            },
